          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Bhavya232003/movie-recommendation-system-master/tree/main/movie-recommendation-system-master" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>
                A movie recommendation system that suggests personalized movies to users based on their preferences using collaborative filtering and content-based techniques.
              </p>
            </div>
            <footer>
            </footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Bhavya232003/ecommerce-1" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                </div>
            </header>
            <div className="body">
              <h3>E-commerce web application</h3>
              <p> A full-stack e-commerce web application with user authentication, product management, and secure checkout functionality built using React and Firebase.
 </p>
            </div>
            <footer> </footer>
          </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Bhavya232003/Sign-Language-Recognition-master" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
                A machine learning-based system that recognizes and translates sign language gestures into text using image processing and deep learning techniques.
              </p>
            </div>
            <footer>
            </footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Bhavya232003/Food-Delivery-app/tree/main/React-food-delivery-app-startup" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>A mobile-friendly food delivery app that allows users to browse restaurants, place orders, and track deliveries in real-time with a user-friendly interface.</p>
            </div>
            <footer>
            </footer>
          </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Bhavya232003/ecommerce-react" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Ecommerce Website made with React.js</h3>
              <p>A responsive e-commerce web app built with React.js, featuring product listings, cart management, and a smooth user shopping experience.
</p>
            </div>
            <footer>
            </footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Bhavya232003/Student-Performance-Prediction/tree/main" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
                A machine learning project that predicts student grades using classifiers on a CSV dataset with academic and behavioral factors, supported by visualizations.</p>
            </div>
            <footer>
